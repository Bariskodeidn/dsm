        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
            <div class="card shadow mb-4">
                <div class="card-header">
                    <p class="card-title"><strong>Tambah Kapal</strong></p>
                </div>
                <div class="card-body">
                    <form class="form-horizontal form-label-left" method="post" action="<?= site_url('agency/insert_kapal') ?>">
                        <div class="item form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="vessel-name" class="form-control ">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="type" class="form-control">
                                        <?php foreach ($kategori as $kat) : ?>
                                            <option value="<?= $kat->Id ?>"><?= $kat->nama_kategori . ' (' . $kat->kode . ')' ?></option>
                                        <?php endforeach; ?>
                                    </select>
                        ...
                        <div class="item form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control nominal" type="text" name="gross">
                        ...
                        <div class="item form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control nominal" type="text" name="gross_barge">
                        ...
                        <div class="item form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control nominal" type="text" name="dwt">
